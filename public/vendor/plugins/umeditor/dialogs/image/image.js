...
//                }
  ...
  var Upload = {
    ...
    '<input style=\"filter: alpha(opacity=0);\" class="edui-image-file" type="file" id="upload_file"  hidefocus name="file" accept="image/gif,image/jpeg,image/png,image/jpg,image/bmp"/>' +
    ...
    uploadComplete: function (r) {
      ...
      try {
        var json = eval('(' + r + ')');
        Base.callback(me.editor, me.dialog, json.key, 'SUCCESS');
      } catch (e) {
